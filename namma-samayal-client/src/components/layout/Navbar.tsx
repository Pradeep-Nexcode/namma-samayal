          ...
          >
            ...
            <div className="flex items-center gap-4 md:gap-5">
              ...
              <div className="hidden sm:flex items-center gap-3">
                ...
                <Link
                  href="/recipes/create"
                  className="inline-flex items-center justify-center rounded-lg bg-[#c0392b] px-4 py-2 font-title-hw text-[15px] font-bold text-white border-2 border-[#c0392b]/40 hover:bg-[#a02b1f] transition-colors shadow-[1px_2px_0_rgba(120,40,40,0.25)] active:translate-y-px active:shadow-none"
                >
                  + {t("nav.newRecipe")}
                </Link>
              </div>
        ...
        >
          ...
          <div className="p-4 pt-2 border-t border-dashed border-stone-200 dark:border-white/[0.06] flex flex-col gap-3">
            ...
            <Link
              href="/recipes/create"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center rounded-xl bg-[#c0392b] px-4 py-3 font-title-hw text-base font-bold text-white border-2 border-[#c0392b]/40 hover:bg-[#a02b1f] transition-colors shadow-[1px_2px_0_rgba(120,40,40,0.25)]"
            >
              + {t("nav.newRecipe")}
            </Link>
          </div>
